...
data_dict = pickle.load( open("./dataset/project_dataset.pkl", "r") )
...
try:
    Draw(pred, finance_features, poi, mark_poi=False, name="3-clusters.pdf", f1_name=feature_1, f2_name=feature_2)
except NameError:
